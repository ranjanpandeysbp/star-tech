...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleRuntimeException(RuntimeException rex){
        ErrorDTO mr = new ErrorDTO();
        mr.setMessage(rex.getMessage());
        return new ResponseEntity<ErrorDTO>(mr, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
