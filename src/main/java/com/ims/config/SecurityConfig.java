...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .and()
                .authorizeHttpRequests().requestMatchers("/api/v1/auth/merchant/**","/api/test/**").authenticated()
                .and()
                ...
                .and()
                .authorizeHttpRequests().requestMatchers("/api/v1/auth/products/**").authenticated()
                .and()
